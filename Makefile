...
pull: $(CHART_DIRECTORY)
	@gcloud storage rsync $(CHART_BUCKET) $(CHART_DIRECTORY) --recursive --delete-unmatched-destination-objects
...
push: package $(CHART_DIRECTORY)
	@gcloud storage rsync $(CHART_DIRECTORY) $(CHART_BUCKET) --recursive --delete-unmatched-destination-objects
